...
int CSDKeliLs1207DEParser::Parse(char *data, size_t data_length, SDKeliLsConfig &config, sensor_msgs::LaserScan &msg)
{
...
void CSDKeliLs1207DEParser::SetRangeMin(float minRange)
{
    fRangeMin = minRange;
}

void CSDKeliLs1207DEParser::SetRangeMax(float maxRange)
{
    fRangeMax = maxRange;
}
...
void CSDKeliLs1207DEParser::SetFrameId(std::string frame_id)
{
    fFrame_id = frame_id;
}

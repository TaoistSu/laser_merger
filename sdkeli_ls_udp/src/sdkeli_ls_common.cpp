...
{
CSDKeliLsCommon::CSDKeliLsCommon(CParserBase *parser, ros::NodeHandle &nh, ros::NodeHandle &pnh) :
    mDiagPublisher(NULL),
...
CSDKeliLsCommon::~CSDKeliLsCommon()
{
    ...
    ROS_INFO("sdkeli_ls_udp drvier exiting.\n");
}
...
void CSDKeliLsCommon::ClearConnectFlag(void)
{
    mConnectFlag = 0;
}
